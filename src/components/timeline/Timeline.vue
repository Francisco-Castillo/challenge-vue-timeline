...
<div>
  ...
  <timeline ref="timeline" :items="timeline.items" :options="timeline.options" :groups="timeline.groups"></timeline>
</div>
</template>
...
const { mapFields } = createHelpers({
  getterType: "TimelineModule/getTimelineField",
  mutationType: "TimelineModule/updateTimelineField"
});

export default {
  computed:{
    ...mapFields({timeline : "timeline"})
  },
  data() {
    return {
